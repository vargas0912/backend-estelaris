...
const CAMPAIGN = Object.freeze({
  ...
  VIEW_BRANCHES: 'view_campaign_branches',
  NAME_VIEW_BRANCHES: 'Ver sucursales de campaña',
  VIEW_STATS: 'view_campaign_stats',
  NAME_VIEW_STATS: 'Ver estadísticas de campaña',
  ADD: 'create_campaign',
...
const CAMPAIGN_PRODUCT = Object.freeze({
  ...
  VIEW_OVERRIDES: 'view_campaign_product_overrides',
  NAME_VIEW_OVERRIDES: 'Ver overrides de sucursal',
...
const LOYALTY = Object.freeze({
  MODULE_NAME: 'loyaltyPoints',
  VIEW_CONFIG: 'view_loyalty_config',
  NAME_VIEW_CONFIG: 'Ver configuración de lealtad',
  CREATE_CONFIG: 'create_loyalty_config',
  NAME_CREATE_CONFIG: 'Crear configuración de lealtad',
  EDIT_CONFIG: 'edit_loyalty_config',
  NAME_EDIT_CONFIG: 'Modificar configuración de lealtad',
  VIEW_POINTS: 'view_loyalty_points',
  NAME_VIEW_POINTS: 'Ver puntos de clientes',
