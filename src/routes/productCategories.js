...
const { validateGetAll, validateGetRecord, valiAddRecord, valiUpdateRecord } = require('../validators/productCategories');
 ...
 *      responses:
 *        '200':
 *          description: Lista de categorías de productos paginada
 *          content:
 *            application/json:
 *              schema:
 *                type: object
